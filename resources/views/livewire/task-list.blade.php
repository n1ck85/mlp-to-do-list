    ...
    <li class="list-group-item task {{ $task->completed ? 'completed' : '' }}">
        <div class="row">
            ...
            <div class="col-4 col-sm-4 col-lg-3 col-xl-2 task-buttons-container text-end">
                <button type="button" class="btn btn-success p-1" wire:click="completeTask({{ $task->id }})">
                    <i>
                ...
                <button type="button" class="btn btn-danger p-1" onclick="if(confirm('Are you sure you want to delete this task?')) { @this.call('deleteTask', {{ $task->id }}) }">
                    <i>
